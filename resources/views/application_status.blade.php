  ...
  <script src="{{asset('plugins/jquery/jquery.min.js')}}"></script> 
             ...
             <div class="card">
              <div class="card-header">
                ...
                <a role="button" class="btn btn-primary" href="{{route('application_reception')}}">New Registration</a> 
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              ...
              @php $explode = explode(',', $application->hold_progress_wizard); @endphp
               ...
               <tr>
                    ...
                    <a style="color:darkblue"  href="{{ route('view_completed_application',$application->application_id)  }}"
                    <i class='fas fa-eye'>View</i>
                    </a>
                    @else
                    <a style="color:orange" href="{{ route('application.update',$application->application_id)  }}"

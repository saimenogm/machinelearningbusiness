...
function log_out()
         ...
         if (confirm("You are Loging out!!") == true)
...
id_for_update.style.display = "none";
      ...
      toastr.error("Product Manufacturer Api  with ID "+ "<br> "+id + "successfully removed from your system")
...
toastr.error("Product Manufacturer  with ID "+ "<br> "+id + "successfully removed from your system")
...
toastr.success("Applicant Number Generated Successfully "+ data.application_number)
...
toastr.success("Applicant and contact infomation successfully saved---->")
...
toastr.success("Applicant and Contact Infomation Successfully Updated")
...
toastr.error("Trade Name With Other Can not Update the selected Trade, update couldnot be made -- Changes not Affected!!")

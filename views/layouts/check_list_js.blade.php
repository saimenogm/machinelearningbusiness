...
$("#save_section_two").toggleClass("btn-danger");
  ...
  Toast.fire({
        icon: 'error',
        color:'red',
        title: 'Save your status for general section then proceed futher with submitting'
      })
...
var Toast = Swal.mixin({
 ...
 toastr.success("General Requirements section two preliminary screening successfuly submited")
...
var Toast = Swal.mixin({
 ...
 toastr.success("Section 4:Sample Details Successfully submitted!!")
...
else if(document.getElementById('local_agent_not_applicable').checked == true) { var local_agent = 'Not-Applicable';}

else if (document.getElementById('local_agent_not_applicable').checked == true) { var local_agent = 0;}
...
if(document.getElementById('local_agent_yes').checked != true && document.getElementById('local_agent_no').checked != true )
{
...
var Toast = Swal.mixin({
              ...
              timer: 6000
                  ...
                  toastr.success("Section two check list successfuly saved ")
...
if(data.section_two_update == true)
{
  var Toast = Swal.mixin({
    ...
    toastr.success("Section two check list successfuly updated ")
...
else if(data.section_two_update ==false)
{
  var Toast = Swal.mixin({
    ...
    toastr.info("Section Two Check List  :No update is made!!")
...
if(data.section_three_update == true)
{
  var Toast = Swal.mixin({
    ...
    toastr.success("Section Three Check List: successfuly updated ")
...
else if(data.section_three_update ==false)
{
  var Toast = Swal.mixin({
    ...
    toastr.info("Section Three Check List  :No update is made!!")
...
else if(document.getElementById('sample_shelf_life_not_applicable').checked == true) { var  sample_shelf_life = 'Not-Applicable';}
...
if(data.section_four_update == true)
{
  var Toast = Swal.mixin({
    ...
    toastr.success("Section Four Check List: Successfuly updated ")
...
else if(data.section_four_update ==false)
{
  var Toast = Swal.mixin({
    ...
    toastr.info("Section Four Check List  :No update is made!!")
...
if(data.section_five_update == true)
{
  var Toast = Swal.mixin({
    ...
    toastr.success("Section Five Check List: Successfuly updated ")
...
else if(data.section_five_update ==false)
{
  var Toast = Swal.mixin({
    ...
    toastr.info("Section Five Check List  :No update is made!!")

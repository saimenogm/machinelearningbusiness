                                    ...
                                    @can('assessor_roles')
                                        ...
                                        @else
                                            <button type="button" class="btn btn-secondary btn-sm"
                                                    title=" Evaluation Already has been Uploaded. "
                                                    data-toggle="modal"
                                                    data-target="#modalextend_section"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="card card-info">
                                    ...
                                    <div class="card-body inline">
                                        ...
                                        <a id="section_sent_document_view" href="" target="_blank" data-toggle="tooltip"
                                           class="btn btn-info btn-sm"
        ...
        <div class="card-body" style="display: none;">
            ...
            <form method="post" action="{{ route('assign_dossier_section') }}"
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="nmfa_units">Unit</label>
                        <select class="form-control select2 select2-hidden-accessible"
                                id='role' name='role' style="width: 100%;" aria-hidden="true"
                                onchange="retrive_staff(this)">
                            <option></option>

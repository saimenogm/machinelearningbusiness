...
<div class="container-fluid" id="grad1">
    <div class="row justify-content-center mt-0">
        ...
        <div  class="alert alert-success align-content-sm-center" id="app_id" >Application-Number == {{ $application_number}}</div>
            ...
            <h2><strong>Update Dossier  Status
                 </strong></h2>
...
{
    $length = strpos($application->dossier_url,'://');
}
 ...
 @endphp
     ...
     <input value="{{ $application->dossier_url }}" id="express_settings_name" style="display:none"  placeholder ="Eg. DHL"  style="width:20px;position:float:left;" class="form-control"  type="text" name="expresss_setting"  /> 
    @endif
        </div>
...
<div class="col-sm-9">
<input  value="" style="display:none"class="form-control" id="dossier_id" type="url" name="dossier_id"    Placeholder="Please write the link where dossier files are located " />
</div>
...
@endif
    ...
    <button     type="button" class="btn btn-success" value="Update"    id="dossier_sample_update"  > Update </button>

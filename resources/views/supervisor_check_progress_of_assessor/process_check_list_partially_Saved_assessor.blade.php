...
<meta name="csrf-token" content="{{ csrf_token() }}">
   ...
   <div class="row">
          <div class="col-12">
            <div class="card" id="print_checklist" style="color: #1c84c6">
 ...
 @php if( $check_lists->is_manufacturer_inforamation == 1) { $check_yes='checked';$check_no='';}  else {$check_no='checked';$check_yes=''; } @endphp 
       ...
       <td > </td>
@php if( $check_lists->is_local_agent == 1) { $check_yes='checked';$check_no='';$check_not_app='';} 
 else if($check_lists->is_local_agent == 0) {$check_no='checked';$check_yes=''; $check_not_app='';} 
 else {$check_no='';$check_yes=''; $check_not_app='checked';}  @endphp 
    ...
    <a class="btn btn-info btn-sm" data-toggle="collapse" href="#collapse3"><b class="fas fa-angle-double-right"> </b> </a></h4></div><div id="collapse3" class="panel-collapse collapse"><div class="panel-body"><span style="color:skyblue">  [If the pharmaceutical product is not listed in the ENLM ensure that the reason for its permit registration is filled in the comment section.] </span></div></div></div> </td>
    <td ></td>
  ...
  <tr>
    <td>Presence of the submitted dossier in CTD format as per the requested format     <div class="panel-group"> <div class="panel panel-default"> <div class="panel-heading pace-center-simple-lime"> <h4 class="panel-title"> <a class="btn btn-info btn-sm" data-toggle="collapse" href="#collapse3"><b class="fas fa-angle-double-right"> </b> </a></h4></div><div id="collapse3" class="panel-collapse collapse"><div class="panel-body"><span style="color:skyblue">  [If the pharmaceutical product is not listed in the ENLM ensure that the reason for its permit registration is filled in the comment section.] </span></div></div></div> </td>
        ...
        <div class="card card-default">
          ...
          <h3 class="card-title">Section 4: Sample details</h3>
            ...
            <td colspan='4' > <input type="text"   palceholder = "How many received?? "size="30" hieght="40"   value="{{ $check_lists->Number_of_samples_received}}"    id="Number_of_sample_received" name="number_of_sample_received" class="form-control"  width="40"/></td>
                      ...
                      <td colspan="4"> Remark <input value="{{ $check_lists->Labelling_Information }}" id="section_four_remark"  type="text"  size="30" hieght="40"  id="labelinfo"  
...
Net Wieght:<input  value="{{ $check_lists->Sample_net_volume_or_weight }}" size="30" hieght="40"  id="sampling_net_weight" placeholder="Enter Weight"  name="sampling_net_weight" class="form-control"  width="40"/> 
Remark <input value="{{ $check_lists->Sample_net_volume_or_weight_remark }}" id="section_four_remark_netweight"  type="text"  size="30" hieght="40"  id="labelinfo"  name="label_info" class="form-control"  width="40"/>
                      ...
                      <td> </td>
                      @php if( $check_lists->Samples_have_at_least_60_perecent== 1)
                       { $check_yes='checked';$check_no='';$check_not_app='';}  
                       else if( $check_lists->Samples_have_at_least_60_perecent== 0)
                       {$check_no='checked';$check_yes='';$check_not_app=''; } 
                       else if( $check_lists->Samples_have_at_least_60_perecent== 'not_applicable')
                       {$check_no='';$check_yes='';$check_not_app='checked'; } 
        ...
        { $check_yes='checked';$check_no='';}  else {$check_no='checked';$check_yes=''; } @endphp 
                      ...
                      <tr>
                      <td colspan='3'> Remark : <textarea  id="summernote_Remark_section_four"  name="remark" value="{{$check_lists->summernote_Remark_section_four }}"class="form-control"  auto/> </textarea> </td>
                      <td>  </td>
                      <td>  </td>
                      </tr>

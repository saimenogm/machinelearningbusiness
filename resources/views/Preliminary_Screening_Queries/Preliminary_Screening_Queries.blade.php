...
<u> 
<b>
<input type="text" id="stregnth"  placeholder="strength" />
...
@endif
<input type="number" min="0" width="10" hieght="10"   placeholder ="number" id="days_of_receipt" /> </span> days of receipt of this notification

the application will be considered closed and you may be required to re-apply
...
<img src="../../../images/nmfa_footer.png"  alt="image" height="90" width="1000"/>       
  ...
  <!-- <div id="actions_to_applicant"  style="float-right;display:block"> 
      ...
      <!-- @if($path_uploaded_query == '')
                  ...
                  @else
                  <a href="{{ $path_uploaded_query }}"  id="get_path_uploaded" rel="noopener" target="_blank" class="btn btn-warning"><i class="fas fa-download"></i> Download Uploaded Doc/Sealed Doc </a>
                   @endif -->

...
<Fieldset>
         ...
         <input id="express_settings_name" style="display:none"  placeholder ="Eg. DHL"  style="width:20px;position:float:left;" class="form-control"  type="text" name="expresss_setting"  /> 
...
<div class="row">
    ...
    <div class="col-sm-9">
            ...
            Placeholder="Please write the link where dossier files are located " />
    </div>
    <div class="col-sm-3">
    ...
    <button   type="button" class="btn btn-success" value="Save"    id="dossier_sample_save"   >Save </button>

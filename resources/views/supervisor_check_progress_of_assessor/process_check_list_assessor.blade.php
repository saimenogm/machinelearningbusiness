...
@foreach($product_enlm_list as $list)     @endforeach
    ...
    <td ></td>
                    ...
                    <td> </td>
                      ...
                      <tr>
                      <td rowspan='5'> Availability of the module of the CTD <div class="panel-group"> <div class="panel panel-default"> <div class="panel-heading pace-center-simple-lime"> <h4 class="panel-title"> <a class="btn btn-info btn-sm" data-toggle="collapse" href="#collapse4"><b class="fas fa-angle-double-right"> </b> </a></h4></div><div id="collapse4" class="panel-collapse collapse"><div class="panel-body"><span style="color:skyblue">  [Please tick the boxes if the relevant modules are available or if certain modules are missing please fill the comment section the acceptable reasons of its absence]</span></div></div></div></div> </td>
...
Net Wieght:<input   size="30" hieght="40"  id="sampling_net_weight" placeholder="Enter Weight"  name="sampling_net_weight" class="form-control"  width="40"/> 

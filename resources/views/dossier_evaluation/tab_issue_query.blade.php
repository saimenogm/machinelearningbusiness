                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form name="upload_response" method="POST"
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" name="query_response_cover_letter"
                                                   ...
                                                   class="custom-file-input" onchange="CheckPDFFile(this)">
                                            <label class="custom-file-label"
                                                   for="query_response_cover_letter">Choose
                                                file</label>
                                        </div>
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" name="query_response_file"
                                                   ...
                                                   class="custom-file-input" onchange="CheckZIPFile(this)" >
                                            <label class="custom-file-label"
                                ...
                                <div class="modal-footer justify-content-between">
                                    <button type="button" class="btn bg-white" data-dismiss="modal">Cancel</button>
                                    <button type="submit" class="btn btn-success" onsubmit="CheckAllDocuments()">Upload</button>
                                </div>
                            </form>
                        </div> {{--modal-body--}}
                    </div>
...
<script>
    ...
    function CheckPDFFile(obj)
    {
        ...
        if (!regex.test(fileUpload.value.toLowerCase())) {
            ...
            var span=document.getElementById("uploaded_document_id")
        ...
        function CheckZIPFile(obj)
    {
        ...
        if (!regex.test(fileUpload.value.toLowerCase())) {
            ...
            response="Please upload files having extensions: " + allowedFiles.join(', ') + " only.";
            var span=document.getElementById("uploaded_zip_document_id")
            span.innerHTML=response
            return false;
        }
    ...
    {
        var allowedFiles = [".doc", ".docx", ".pdf"];
        var fileUpload = document.getElementById("query_response_cover_letter");
        var regex = new RegExp("([a-zA-Z0-9\s_\\.\-:])+(" + allowedFiles.join('|') + ")$");
        if (!regex.test(fileUpload.value.toLowerCase())) {
        ...
        //this code belows validates zip input
        var allowedFiles = [".zip", ".rar"];
        var fileUpload = document.getElementById("query_response_file");;
        var regex = new RegExp("([a-zA-Z0-9\s_\\.\-:])+(" + allowedFiles.join('|') + ")$");
        if (!regex.test(fileUpload.value.toLowerCase())) {

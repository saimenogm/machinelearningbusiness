    ...
    public function handle()
    {
        ...
        $assignments = dossier::join('dossier_status_lookups', 'dossier_status_lookups.id', 'dossiers.assignment_status')
            ...
            ->select([
                ...
                'quality_controls.inspection_sent_date as sent_date',
        ...
        foreach ($assignments as $assignment) {
            ...
            //todo delete following test lines
            ...
            if ($assignment->received_date == null) {
                if ($first_reminder_day == $elapsed_days) {
                    ...
                    QualityControl::where('qc_related_id', $assignment->dossier_assign_id)->update([
                        'status' => 'Locked'
                    ]);

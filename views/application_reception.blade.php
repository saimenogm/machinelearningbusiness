                    ...
                    <div class="col-md-12 mx-0">
                        <form id="msform">
                            ...
                            <ul id="progressbar">
                                ...
                                <li id="product_details" class="fas fa-supple"><strong>Product Details</strong></li>
                                <li id="product_composition" class="fas fa-supple"><strong>Product Composition</strong></li>
                                <li id="product_manufacturers" class="fas fa-supple"><strong>Product Manufacturers</strong></li>
                                <li id="product_manufacturers_api" class="fas fa-supple"><strong> API Product Manufacturers</strong></li>
                               <!-- <li id="dossier_sample" clas="fas fa-supple"><strong> Dossier Link and Sample</strong></li>-->
                                <li id="decleration" class="fas fa-supple"><strong> Declaration</strong></li>
...
<br><br/>
            ...
            <input class="form-control" id="shelf_life_amount" type="number"  placeholder=""   name="shelf_life_amount"  required/>
...
<!-------------------                        ---->
    ...
    <label>Name</label>  
       ...
       <select  onchange="fetch_tele(this.value,'manu_api_response_tele','{{url('/get_tele_code/tele_code')}}')"  class="form-control select2bs4" style="width: 100%;" name="manufacturer_api_country_id" id="manufacturer_api_country"  required>
        ...
        <label>Telephone</label>  
        <input class="form-control" id="manufacturer_api_tele" type="number" name="manufacturer_tele"  />
        </div>
<div class="col-12 col-sm-6">
        <label>City</label>  
...
<!-- <label>I agree <input style="width:20px;position:float-center;" class="form-control" id="customCheckbox1" type="checkbox" name="customCheckbox1"   /></label>   -->
    ...
    <!-- <input type="button" class="save action-update" value="Update"    id="decleration_sample_update"       > -->
     ...
     <a  href="" type="button" class="btn btn-warning float-right no-print" style="margin-right: 5px;"  id="print_decla">

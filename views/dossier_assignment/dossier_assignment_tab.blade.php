                            ...
                            <div class="card card-primary card-outline card-tabs">
                                <div class="card-header p-0 pt-1 border-bottom-0">
                                    ...
                                    <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="custom-tabs-three-all-tab" data-toggle="pill" href="#custom-tabs-three-all"
                                                role="tab" aria-controls="custom-tabs-three-all" onclick="change_tab_num('custom-tabs-three-all')"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content" id="custom-tabs-three-tabContent">
                                        ...
                                        @include('dossier_assignment.all_tab')

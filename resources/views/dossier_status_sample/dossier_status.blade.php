  ...
  <script src="{{asset('plugins/jquery/jquery.min.js')}}"></script>
        ...
        @if(in_array('7',$explode))
               ...
               <tr  style="{{ $tr }}">
                    ...
                    <button  title="shows:Dossier needs to be completed"class="btn btn-warning btn-xs"
                    <i   class='fas fa-ruler'>Pending</i>
                    </button>
                  @else
                    <button  title="shows:Dossier is Completed"class="btn btn-success btn-xs"
                   ...
                   <td>
                    ...
                    <i style="color:orange" class='fas fa-pencil-ruler'></i>
                    </a>
                  @else
